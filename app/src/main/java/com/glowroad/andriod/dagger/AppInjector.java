package com.glowroad.andriod.dagger;
...
import com.glowroad.andriod.dagger.component.DaggerAppComponent;
...
public class AppInjector {
    ...
    public static void init(GlowRoadApplication application) {
